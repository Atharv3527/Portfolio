...
export const Contact = () => {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('atharvwaykar3@gmail.com');
    setCopied(true);
    ...
    <section id="contact" className="contact-section-new">
      ...
      <div className="contact-marquee-wrapper">
        <div className="contact-marquee">
          <span>GET IN TOUCH • OPEN TO WORK • GET IN TOUCH • OPEN TO WORK • GET IN TOUCH • OPEN TO WORK • GET IN TOUCH • OPEN TO WORK • </span>
          <span>GET IN TOUCH • OPEN TO WORK • GET IN TOUCH • OPEN TO WORK • GET IN TOUCH • OPEN TO WORK • GET IN TOUCH • OPEN TO WORK • </span>
        </div>
      </div>
      ...
      <div className="contact-content-wrapper">
        <div className="contact-grid-new">
          ...
          <div className="contact-left">
            <h2 className="contact-main-title">
              Let's start a<br />
              <span className="contact-gradient-text">project together</span>
            </h2>
            ...
            <div className="contact-info-items">
              <div className="contact-info-item">
                ...
                <div>
                  ...
                  <p className="contact-info-value">Pimpri-Chinchwad, India</p>
                </div>
              </div>
              ...
              <div className="contact-info-item">
                ...
                <div>
                  ...
                  <p className="contact-info-value">atharvwaykar3@gmail.com</p>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="contact-form-new">
                <div className="form-row">
                  <div className="form-group-new">
                    <label htmlFor="fullName" className="form-label-new">NAME</label>
                    <input
                      type="text"
                      id="fullName"
                      name="fullName"
        ...
        {/* Footer Section */}
        <div className="contact-footer-new">
          <p className="footer-text">CONNECT WITH ME ON SOCIALS</p>
          ...
          <p className="footer-copyright">© 2026 ATHARV. BUILT WITH PRECISION.</p>
        </div>
      </div>
    </section>
  );
